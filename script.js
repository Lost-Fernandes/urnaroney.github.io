...
function showCandidate() {
    ...
    if (candidateNumber === '15999') {
        displayCandidate(candidato.drroney);
    } else {
        displayInvalid();
    }
}
...
function displayCandidate(candidate) {
    ...
    img.style.backgroundImage = `url(${candidate.img})`; // Corrigido
...
let candidato = {
    drroney: {
        name: 'VEREADOR',
        nameComplete: 'Dr. Roney',
        broken: 'MDB',
        img: './images/vereador.jpeg', // Corrigido
    },
};
